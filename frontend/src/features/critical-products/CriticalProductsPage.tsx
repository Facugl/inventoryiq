...
import type { CriticalProduct, ProductStatus } from '../../api/types'
import { STORES } from '../../data/stores'
import './CriticalProductsPage.css'
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.productId}>
                ...
                <td>
                  <span className={`status status-${product.status.toLowerCase().replaceAll('_', '-')}`}>
